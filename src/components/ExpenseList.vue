...
.tx-table{ width:100%; border-collapse:collapse; color:#e7e7e7; font-size:.92rem; }
.tx-table thead th{
  text-align:left; font-weight:600; color:#a0a0a0; padding:12px 14px; border-bottom:1px solid #2a2a2a;
}
.tx-table tbody td{ padding:12px 14px; border-bottom:1px solid #2a2a2a; }
.tx-table tbody tr:hover td{ background:#181818; }

.badge{ font-size:.75rem; padding:.15rem .55rem; border-radius:999px; font-weight:600; display:inline-block; }
.badge-green{ background:#123e28; color:#7ff0b5; border:1px solid #1b8a56; }
.badge-red{ background:#3b1616; color:#ffb4b4; border:1px solid #a33c3c; }
.badge-blue{ background:#0d2b47; color:#7ec4ff; border:1px solid #274b6e; }

.muted{ color:#cfcfcf; }
.actions{ white-space:nowrap; }
.link{ background:none; border:none; color:#76eab3; cursor:pointer; font-weight:600; }
.link.red{ color:#ff9c9c; }
</style>
